...
class _CreateElectionScreenState extends State<CreateElectionScreen> {
  ...
  Widget build(BuildContext context) {
    final createelectionformkey = GlobalKey<FormState>();
    return Form(
      key: createelectionformkey,
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
  ...
  Future<void> createelection() async {
    ...
    await context.read<FirestoreProvider>().createelection(data);
  }
}
